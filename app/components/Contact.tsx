    ...
    <section id="contact" className="py-24 px-4 bg-white">
      <div ref={ref} className={`max-w-4xl mx-auto transition-all duration-700 ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        <h2 className="text-3xl sm:text-4xl font-bold mb-2">
          <span className="bg-gradient-to-r from-stone-700 to-stone-800 bg-clip-text text-transparent">Get In Touch</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <button
            ...
            className="group bg-stone-50 rounded-xl p-6 border border-stone-200 hover:border-stone-400 transition-all hover:scale-[1.02] text-left w-full shadow-sm"
          >
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-stone-700 font-medium group-hover:text-stone-900 transition-colors">
          ...
          <a href={`tel:${portfolioData.phone.replace(/\s/g, '')}`}
            className="group bg-stone-50 rounded-xl p-6 border border-stone-200 hover:border-stone-400 transition-all hover:scale-[1.02] shadow-sm">
            <div className="flex items-center gap-4 mb-3">
          ...
          <a href={"https://www.linkedin.com/in/r-ganesh-"} target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <p className="text-stone-400 text-sm">LinkedIn</p>
                <p className="text-stone-700 font-medium group-hover:text-stone-900 transition-colors">
                  Connect with me
                </p>
              </div>
          ...
          {/* Location */}
          <div className="bg-stone-50 rounded-xl p-6 border border-stone-200 shadow-sm">
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                ...
                <p className="text-stone-700 font-medium">Trichy, Tamil Nadu, India</p>
              </div>
            </div>
          </div>
        </div>
