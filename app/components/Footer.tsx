...
export default function Footer() {
  ...
  return (
    <footer className="py-12 px-4 border-t border-stone-200 bg-stone-50">
      <div className="max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-center md:text-left">
            <p className="text-2xl font-bold bg-gradient-to-r from-stone-700 to-stone-800 bg-clip-text text-transparent mb-1">
              {portfolioData.name}
            </p>
            <p className="text-stone-400 text-sm">{portfolioData.title}</p>
          </div>
